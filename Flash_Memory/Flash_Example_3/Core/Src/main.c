...
//Erase the memory sector
//Write 1 , 2, 3, 4 to the memory address
//Read them back
/**
  ******************************************************************************
  * @file           : main.c
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  // Erase the Flash sector before writing
	      ...
	      // Reset Address to start reading
	      Address = 0x0802F080;
...
//	          HAL_FLASH
	          //HAL_UART_Transmit(&huart2, READDATA[i], sizeof(READDATA[i]), HAL_MAX_DELAY);
	          Address+=8;
	      }
	      HAL_FLASH_Lock();
    /* USER CODE BEGIN 3 */
