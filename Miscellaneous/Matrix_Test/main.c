...
/* USER CODE BEGIN PV */
//uint8_t data1[] = "Timer Two\r\n";  // Data to send over UART
//uint8_t data2[] = "HAL_TIM_Base_Start_IT\r\n";
//uint8_t data3[] = "Timer Three\r\n";
//uint8_t data4[] = "Timer Four\r\n";
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void Matrix_Multiply(float A[MATRIX_SIZE][MATRIX_SIZE], float B[MATRIX_SIZE][MATRIX_SIZE], float C[MATRIX_SIZE][MATRIX_SIZE]) {
...
//  {
//	  //HAL_UART_Transmit(&huart2, data3, sizeof(data3), HAL_MAX_DELAY);
//	  printf(data3);
//  }
//  if(htim->Instance == TIM4)
//  {
//	  //HAL_UART_Transmit(&huart2, data4, sizeof(data4), HAL_MAX_DELAY);
//	  printf(data4);
//  }
//}
/* USER CODE END 4 */
