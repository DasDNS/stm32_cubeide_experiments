  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  // Receive the .wav file data via UART
	          if (HAL_UART_Receive(&huart1, uart_buffer, UART_BUFFER_SIZE, HAL_MAX_DELAY) == HAL_OK)
	          {
	              ...
	              HAL_UART_Transmit(&huart1, (uint8_t *)fft_magnitude, sizeof(fft_magnitude), HAL_MAX_DELAY);
	          }
